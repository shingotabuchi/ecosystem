...
{   
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < fishToSpawn; i++)
        {
            ...
            newFishScript.impulseTime = Random.Range(1f,4.5f);
            newFishScript.kyuukaku = Random.Range(10f,50f);
            newFishScript.soshakuJikan = Random.Range(1f,15f);
            newFishScript.matingRestJikan = Random.Range(1f,9f);
            newFishScript.matingAge = Random.Range(5f,15f);
            newFishScript.jumyou = Random.Range(200f,300f);
            newFishScript.potentialBenefitOfMovement = Random.Range(1f,8f);
            newFishScript.minimunEnergyToMate = Random.Range(10f,50f);
